...
from .models import Category, Product, Rating, Email, Review, Customer
from .forms import LoginForm, RegisterForm, EmailForm, ReviewForm, ShippingAddressForm
...
def pay_failed(request):
    messages.success(request, "You order failed!")
